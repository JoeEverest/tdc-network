...
function EditSkillForm({ userSkill, onSuccess, onCancel }: EditSkillFormProps) {
  ...
  const skillName =
    typeof userSkill.skill === "string"
      ...
      : userSkill.skill.name;
  const skillId =
    typeof userSkill.skill === "string" ? userSkill.skill : userSkill.skill._id;
...
export function UserProfile() {
  ...
  const handleRemoveSkill = async (userSkill: UserSkill) => {
    if (!user || !window.confirm("Are you sure you want to remove this skill?"))
      return;
