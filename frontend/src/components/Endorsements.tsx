...
const userEndorsements = [
  {
    ...
    rating: 8,
    comment:
      "Excellent React developer with deep understanding of hooks and state management.",
...
export function Endorsements() {
  ...
  const getSkillStats = () => {
    ...
    const skillRatings = userEndorsements.reduce(
      (acc, endorsement) => {
    ...
    return Object.entries(skillCounts).map(([skill, count]) => ({
      ...
      count,
      averageRating:
        skillRatings[skill].reduce((a, b) => a + b, 0) /
        skillRatings[skill].length,
    }));
  };
        ...
        >
          ...
          <div className="flex gap-2">
            <Button
              ...
              disabled={!endorseForm.memberName || !endorseForm.skill}
            >
              Submit Endorsement
            </Button>
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        endorsed your {endorsement.skill}
                      </p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        you endorsed their {endorsement.skill}
                      </p>
                    </div>
                  </div>
                  <div className="text-right">
